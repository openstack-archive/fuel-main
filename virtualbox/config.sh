...
# Fuel 3.2 controllers require 1280 MiB of RAM as absolute minimum due to Heat!
vm_slave_memory_default=1280
...
vm_slave_memory_mb[1]=1280  # for controller node in non-HA mode 768 MB should be sufficient
