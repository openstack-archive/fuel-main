...
enable_outbound_network_for_product_vm() {
    ...
    result=$(
        ...
        expect "$prompt"
        send "/usr/bin/dockerctl-test check nailgun\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check nginx\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check rabbitmq\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check astute\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check rsync\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check keystone\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check postgres\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check rsyslog\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check cobbler\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check ostf\r"
        expect "$prompt"
        send "/usr/bin/dockerctl-test check mcollective\r"
        expect "$prompt"
