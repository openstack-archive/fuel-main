...
ssh_options0='-oConnectTimeout=5 -oStrictHostKeyChecking=no -oCheckHostIP=no'
ssh_options1=' -oUserKnownHostsFile=/dev/null -oRSAAuthentication=no'
ssh_options2=' -oPubkeyAuthentication=no'
ssh_options=$(echo $ssh_options0 && echo $ssh_options1 && echo $ssh_options2)
