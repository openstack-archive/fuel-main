...
if [ "$skipfuelmenu" = "yes" ]; then
  ...
  cmdline="${cmdline:- initrd=initrd.img biosdevname=0 ks=hd:sr0:/ks.cfg ip=10.20.0.2::10.20.0.1:255.255.255.0:fuel.domain.tld:eth0:off::: dns1=10.20.0.1 selinux=0}"
