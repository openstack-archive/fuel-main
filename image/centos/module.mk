...
$(BUILD_DIR)/images/$(TARGET_CENTOS_IMG_ART_NAME):
	...
	find $(SANDBOX) -name "centos_$(CENTOS_IMAGE_RELEASE)_$(CENTOS_ARCH)*.img" -exec sudo mv '{}' $(BUILD_DIR)/image/centos/ \;
	find $(BUILD_DIR)/image/centos -name 'centos_$(CENTOS_IMAGE_RELEASE)_$(CENTOS_ARCH)*.img' -exec gzip -f '{}' \;
