...
# This section is to be deprecated as separate file systems images are ready
	...
	sudo mkfs.ext2 $(BUILD_DIR)/image/centos/centos_$(CENTOS_IMAGE_RELEASE)_$(CENTOS_ARCH)-boot.img
	...
	sudo mv $(BUILD_DIR)/image/centos/image_root/boot/* $(BUILD_DIR)/image/centos/image_boot
	sudo mv $(BUILD_DIR)/image/centos/image_root/boot/.* $(BUILD_DIR)/image/centos/image_boot
