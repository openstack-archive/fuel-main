...
sudo chroot ${TMP_CHROOT_DIR} DEBIAN_FRONTEND=noninteractive apt-get -q -y install cloud-init
...
sudo chroot ${TMP_CHROOT_DIR} DEBIAN_FRONTEND=noninteractive dpkg-reconfigure cloud-init
