...
module MCollective
  module Agent
    class Rpuppet < RPC::Agent
      ...
      action "run" do
        # mco rpc rpuppet run data='{"environment": "production",
        # "classes": {"nailytest::test_rpuppet": {"rpuppet": ["controller"]}}}' -v
        ...
        cmdline = Puppet::Util::CommandLine.new("puppet",
                                                ["apply",
                                                 "/dev/null",
                                                 "--modulepath=/opt/fuel",
                                                 "--debug",
                                                 "--logdest=/var/log/puppetrun.log",
                                                 "--node_terminus=exec"])
