...
class TempestConfigState(object):
    ...
    def __init__(self, nailgun_uri, cluster_id,
        ...
        """WARNING!!!
        kwargs would be directly provided to templates and may be used inside
        configuration
        """
...
if __name__ == '__main__':
    ...
    tempest_conf = '/home/fuel/tempest/etc/tempest.conf'
    conf = TempestConfigState(nailgun_uri, 1, tempest_conf=tempest_conf)
    conf.configure()
    conf.copy_config()
    print 'Ive finished without errors'
