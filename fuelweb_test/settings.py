...
FORWARD_DEFAULT = os.environ.get('FORWARD_DEFAULT', 'nat')
ADMIN_FORWARD = os.environ.get('ADMIN_FORWARD', FORWARD_DEFAULT)
PUBLIC_FORWARD = os.environ.get('PUBLIC_FORWARD', FORWARD_DEFAULT)
