    ...
    def nine_nodes_mixed(self):
        ...
        self.fuel_web.update_nodes(
            cluster_id,
            {
                ...
                'slave-05': ['compute', 'mongo', 'ceph-osd'],
                'slave-06': ['compute', 'mongo', 'ceph-osd'],
                'slave-07': ['compute', 'mongo', 'ceph-osd'],
                'slave-08': ['compute', 'mongo', 'ceph-osd'],
                'slave-09': ['compute', 'mongo', 'ceph-osd']
            }
        )
        # Cluster deploy
