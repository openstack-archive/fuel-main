...
class VcenterDeploy(TestBasic):
    ...
    def vcenter_one_node_simple(self):
        ...
        Scenario:
            ...
            4. Verify that the cluster was set up correctly, there are no dead services
    ...
    def vcenter_multiple_cluster(self):
        ...
        Scenario:
            ...
            6. Check connectivity between 2 instances that are running in different vSphere clusters
