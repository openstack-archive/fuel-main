...
class BondingSimple(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_bonding_balance_tcp"])
    @log_snapshot_on_error
    def deploy_bonding_balance_tcp(self):
        """Deploy cluster in simple mode with bonding
        ...
        Snapshot deploy_bonding_balance_tcp
        ...
        self.env.make_snapshot("deploy_bonding_balance_tcp")
...
class BondingHA(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["deploy_bonding_ha_balance_tcp"])
    @log_snapshot_on_error
    def deploy_bonding_ha_balance_tcp(self):
        """Deploy cluster in HA mode with bonding
        ...
        Snapshot deploy_bonding_ha_balance_tcp
        ...
        self.env.make_snapshot("deploy_bonding_ha_balance_tcp")
