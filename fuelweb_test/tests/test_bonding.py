...
@test(groups=["thread_3", "bonding"])
class Bonding(TestBasic):

    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deplot_simple_flat_with_bonding"])
    @log_snapshot_on_error
    def deploy_simple_flat_with_bonding(self):
        ...
        self.env.make_snapshot("deplot_simple_flat_with_bonding")
