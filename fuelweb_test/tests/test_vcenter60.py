...
class VcenterDeploy(TestBasic):
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["vcenter60_case01", "vcenter60_simples"])
    @log_snapshot_on_error
    def vcenter60_case01(self):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_1],
          groups=["vcenter60_case2", "vcenter60_simples"])
    @log_snapshot_on_error
    def vcenter60_case2(self):
        """Deploy cluster with controller node only
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["vcenter60_case3", "vcenter60_simples"])
    @log_snapshot_on_error
    def vcenter60_case3(self):
