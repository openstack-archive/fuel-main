...
class LbaasPlugin(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_neutron_vlan_lbaas_simple"])
    @log_snapshot_on_error
    def deploy_neutron_vlan_lbaas_simple(self):
        ...
        agents_list = os_conn.get_neutron_agent_list()
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_neutron_gre_lbaas_simple"])
    @log_snapshot_on_error
    def deploy_neutron_lbaas_simple(self):
        ...
        Snapshot deploy_neutron_gre_lbaas_simple
        ...
        # get list of vips
        lb_vip_list = os_conn.get_vips()
        logger.debug('list vip is {0}'.format(lb_vip_list))
        ...
        self.env.make_snapshot("deploy_neutron_gre_lbaas_simple")
