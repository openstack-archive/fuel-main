...
def get_tests_descriptions():
    ...
    for case in TestProgram().cases:
            ...
            test_case = {
                ...
                "estimate": "0m",
                "refs": "",
                "custom_test_method": case.entry.home.func_name,
...
def upload_tests_descriptions(client, tests, section_id):
    base_setup_tests = ["setup", "prepare_slaves_1", "prepare_slaves_3",
                        "prepare_slaves_5", "prepare_slaves_9"]
    for test in tests:
        if test["custom_test_method"] not in base_setup_tests:
...
if __name__ == '__main__':
    ...
    testrail_client.password = os.environ.get('TESTRAIL_USER', 'password')
