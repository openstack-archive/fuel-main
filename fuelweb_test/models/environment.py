...
from fuelweb_test.helpers.multiple_networks_hacks import *
...
class EnvironmentModel(object):
    ...
    def setup_environment(self):
        ...
        if settings.MULTIPLE_NETWORKS:
            ...
            configure_second_admin_cobbler(self)
            configure_second_dhcrelay(self)
    ...
    def describe_second_admin_interface(self):
        ...
        configure_second_admin_firewall(self,
