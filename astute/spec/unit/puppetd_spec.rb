...
describe "Puppetd" do
  context "PuppetdDeployer" do
    it "should run deploy method" do
      # This test only checks that deploy method doesn't raise exceptions,
      #  some expected methods of rpcclient are called, result of rpcclient is parseable
      # TODO: check that deployment is successfully finished.
      @ctx = mock
      @ctx.stubs(:task_id)
