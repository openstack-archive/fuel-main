  ...
  module LogParser
    ...
    @default_patterns = {
      'puppet-log-components-list' =>   # key for default pattern
        ...
        'components_list' => [
          {'name' => 'Galera', 'weight' => 10, 'patterns' => [
          ...
          {'name' => 'Haproxy', 'weight' => 10, 'patterns' => [
          ...
          {'name' => 'Keepalived', 'weight' => 10, 'patterns' => [
          ...
          {'name' => 'Rsync/Xinetd', 'weight' => 10, 'patterns' => [
             ...
             {'pattern' => '/Stage[main]/Rsync::Server/Xinetd::Service[rsync]/File[/etc/xinetd.d/rsync]/content) content changed', 'progress' => 0.7},
             ]
          },
          {'name' => 'Swift', 'weight' => 10, 'patterns' => [
             {'pattern' => '/Stage[main]/Swift::Xfs/Package[xfsprogs]/ensure) created', 'progress' => 0.1},
             {'pattern' => '/Stage[main]/Swift/File[/etc/swift/swift.conf]/content) content changed', 'progress' => 0.2},
             {'pattern' => '/Stage[main]/Swift/File[/home/swift]/ensure) created', 'progress' => 0.25},
             {'pattern' => '/Stage[main]/Swift::Storage::All/File[/srv/node]/ensure) created', 'progress' => 0.3},
             {'pattern' => '/Stage[main]/Swift::Storage::Account/Swift::Storage::Generic[account]/File'\
                           '[/etc/swift/account-server/]/ensure) created', 'progress' => 0.35},
             {'pattern' => '/Stage[main]/Swift::Storage::Object/Swift::Storage::Generic[object]/Package'\
                           '[swift-object]/ensure) created', 'progress' => 0.4},
             {'pattern' => "/Stage[main]/Swift::Storage::Account/Swift::Storage::Generic[account]/Service"\
                           "[swift-account]/ensure) ensure changed 'stopped' to 'running'", 'progress' => 0.45},
             {'pattern' => "/Stage[main]/Swift::Storage::Object/Swift::Storage::Generic[object]/Service"\
                           "[swift-object]/ensure) ensure changed 'stopped' to 'running'", 'progress' => 0.5},
             {'pattern' => '/Stage[main]/Swift::Keystone::Auth/Keystone_service[swift]/ensure) created', 'progress' => 0.55},
             {'pattern' => '/Stage[main]/Swift::Keystone::Auth/Keystone_user_role[swift@services]/ensure) created', 'progress' => 0.6},
             {'pattern' => '/Stage\[main\]/Swift::Storage::Container/Ring_container_device\[[0-9.:]+\]/ensure\) created',
                           'regexp' => true, 'progress' => 0.65},
             {'pattern' => "/Stage[main]/Swift::Storage::Account/Swift::Storage::Generic[account]/File[/etc/swift/"\
                           "account-server/]/group) group changed 'root' to 'swift'", 'progress' => 0.7},
             {'pattern' => '/Stage[main]/Swift::Ringbuilder/Swift::Ringbuilder::Rebalance[object]/Exec'\
                           '[hours_passed_object]/returns) executed successfully', 'progress' => 0.75},
             {'pattern' => '/Stage[main]/Swift::Ringbuilder/Swift::Ringbuilder::Rebalance[account]/Exec'\
                           '[hours_passed_account]/returns) executed successfully', 'progress' => 0.8},
             {'pattern' => '/Stage[main]/Swift::Ringbuilder/Swift::Ringbuilder::Rebalance[account]/Exec'\
                           '[rebalance_account]/returns) executed successfully', 'progress' => 0.85},
             {'pattern' => '/Stage[main]/Swift::Ringbuilder/Swift::Ringbuilder::Rebalance[container]/Exec'\
                           '[hours_passed_container]/returns) executed successfully', 'progress' => 0.9},
             {'pattern' => '/Stage[main]/Swift::Ringbuilder/Swift::Ringbuilder::Rebalance[container]/Exec'\
                           '[rebalance_container]/returns) executed successfully', 'progress' => 0.95},
             {'pattern' => '/Stage[main]/Swift::Proxy/Package[swift-proxy]/ensure) created', 'progress' => 1},
             ]
          },
