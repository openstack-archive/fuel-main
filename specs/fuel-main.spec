...
ln -s %{_sysconfdir}/fuel_release %{buildroot}%{_sysconfdir}/yum/vars/fuelver
...
# copy GPG key
install -D -m 644 %{_builddir}/%{name}-%{version}/fuel-release/RPM-GPG-KEY-mos %{buildroot}/etc/pki/fuel-gpg/
