...
#MOS mirrors
deb $(MIRROR_UBUNTU_METHOD)://$(MIRROR_UBUNTU)/$(PRODUCT_NAME)/ubuntu $(PRODUCT_NAME)$(PRODUCT_VERSION) main restricted
deb $(MIRROR_UBUNTU_METHOD)://$(MIRROR_UBUNTU)/$(PRODUCT_NAME)/ubuntu $(PRODUCT_NAME)$(PRODUCT_VERSION)-security main restricted
deb $(MIRROR_UBUNTU_METHOD)://$(MIRROR_UBUNTU)/$(PRODUCT_NAME)/ubuntu $(PRODUCT_NAME)$(PRODUCT_VERSION)-proposed main restricted
deb $(MIRROR_UBUNTU_METHOD)://$(MIRROR_UBUNTU)/$(PRODUCT_NAME)/ubuntu $(PRODUCT_NAME)$(PRODUCT_VERSION)-updates main restricted
deb $(MIRROR_UBUNTU_METHOD)://$(MIRROR_UBUNTU)/$(PRODUCT_NAME)/ubuntu $(PRODUCT_NAME)$(PRODUCT_VERSION)-holdback main restricted
#Perestroika
deb $(MIRROR_UBUNTU_METHOD)://$(MIRROR_UBUNTU)$(MIRROR_UBUNTU_ROOT) $(UBUNTU_RELEASE) main
#Extra repositories
