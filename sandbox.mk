...
sudo echo "deb file:///tmp/apt $(UBUNTU_RELEASE) main" > $(SANDBOX_UBUNTU)/etc/apt/sources.list
sudo echo "APT::Get::AllowUnauthenticated 1;" $(SANDBOX_UBUNTU)/etc/apt/apt.conf.d/02mirantis-unauthenticated
