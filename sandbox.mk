...
sudo chroot $(SANDBOX) sh -c 'export DBPATH=$$(rpm -E "%_dbpath"); mkdir -p $$DBPATH; echo "mutex_set_max 10000" > $$DBPATH/DB_CONFIG'
sudo chroot $(SANDBOX) sh -c 'ls -al /var/lib/rpm'
#sudo chroot $(SANDBOX) sh -c 'echo "mutex_set_max 10000" > /var/lib/rpm/DB_CONFIG'
