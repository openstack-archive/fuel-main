$(BUILD_DIR)/mirror/ubuntu/createchroot.done: 
	...
	echo deb $(LOCAL_MIRROR_UBUNTU_OS_BASEURL) $(UBUNTU_RELEASE)-updates main universe multiverse restricted | sudo tee $(LOCAL_MIRROR_UBUNTU_OS_BASEURL)/chroot/etc/apt/sources.list.d/mirantis.list
