$(BUILD_DIR)/mirror/ubuntu/createchroot.done: 
	...
	echo deb $(MIRROR_UBUNTU) $(UBUNTU_RELEASE)-updates main universe multiverse | sudo tee -a $(LOCAL_MIRROR_UBUNTU_OS_BASEURL)/chroot/etc/apt/sources.list
	echo deb $(MIRROR_UBUNTU) $(UBUNTU_RELEASE)-backports main universe multiverse | sudo tee -a $(LOCAL_MIRROR_UBUNTU_OS_BASEURL)/chroot/etc/apt/sources.list
