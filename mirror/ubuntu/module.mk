...
$(BUILD_DIR)/mirror/ubuntu/mirror.done:
	...
	--dist=$(MIRROR_MOS_UBUNTU_SUITE),$(MIRROR_MOS_UBUNTU_SUITE)-security,$(MIRROR_MOS_UBUNTU_SUITE)-proposed,$(MIRROR_MOS_UBUNTU_SUITE)-updates,$(MIRROR_MOS_UBUNTU_SUITE)-holdback \
