...
ifeq ($(USE_MIRROR),none)
	wget -O $@ http://ru.archive.ubuntu.com/ubuntu/dists/precise-updates/main/installer-amd64/current/images/trusty-netboot/netboot.tar.gz
else
	wget -O $@ http://ru.archive.ubuntu.com/ubuntu/dists/precise-updates/main/installer-amd64/current/images/netboot/netboot.tar.gz
endif
