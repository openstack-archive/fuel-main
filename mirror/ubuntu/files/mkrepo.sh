...
# linux-image-3.11.0-24 used for installer
apt-get -dy install linux-image-3.11.0-24 || exit 1
...
# Find modules for 3.11.0-24 kernel (installer runs with this version)
for package in `cat ${wrkdir}/UPackages.tmp | egrep "generic|virtual" | grep 3.11.0-24`; do
