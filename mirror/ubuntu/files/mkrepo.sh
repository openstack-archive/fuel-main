...
# linux-image-3.13.0-32 used for installer
apt-get -dy install linux-image-3.13.0-32 || exit 1
...
# Find modules for 3.13.0-32 kernel (installer runs with this version)
for package in `cat ${wrkdir}/UPackages.tmp | egrep "generic|virtual" | grep 3.13.0-32`; do
