...
########################
diff-repo: $(ARTS_DIR)/$(DIFF_MIRROR_ART_NAME)

$(ARTS_DIR)/$(DIFF_MIRROR_ART_NAME): $(BUILD_DIR)/mirror/diff-repo.done
	mkdir -p $(@D)
...
$(BUILD_DIR)/mirror/diff-repo.done:
	mkdir -p $(LOCAL_MIRROR)
	tar xf $(DIFF_MIRROR_DEP_FILE) -C $(LOCAL_MIRROR) --xform s:^diff-repo/::
