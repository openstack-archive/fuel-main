...
ifdef DIFF_CENTOS_REPO_DEP_FILE
...
$(BUILD_DIR)/mirror/$(DIFF_CENTOS_REPO_ART_NAME): OLDDIR=$(BUILD_DIR)/mirror/$2/centos/os/$(CENTOS_ARCH)/Packages
...
#	unpacking old version centos mirror
	...
	tar xf $(DEPS_DIR)/$2/$(CENTOS_REPO_ART_NAME) -C $(BUILD_DIR)/mirror/$2  --xform s:^centos-repo/::
...
endif # ifdef DIFF_CENTOS_DEP_FILE
endif # ifneq ($2,)
...
ifdef DIFF_UBUNTU_REPO_DEP_FILE
...
$(BUILD_DIR)/mirror/$(DIFF_UBUNTU_REPO_ART_NAME): OLDDIR=$(BUILD_DIR)/mirror/$2/ubuntu/pool/main
...
#	unpacking old version ubuntu mirror
	mkdir -p $(BUILD_DIR)/mirror/$2
	tar xf $(DEPS_DIR)/$2/$(UBUNTU_REPO_ART_NAME) -C $(BUILD_DIR)/mirror/$2  --xform s:^ubuntu-repo/::
#	copying packages which differ from those in old version
	mkdir -p $$(DIFFDIR)
	/bin/bash $(SOURCE_DIR)/mirror/create_diff_mirrors.sh $$(NEWDIR) $$(OLDDIR) $$(DIFFDIR)
#	creating diff mirror
...
endif # ifdef DIFF_UBUNTU_DEP_FILE
endif # ifneq ($2,)
