...
dpkg-scanpackages -m ${RESULT_DIR}/ubuntu/pool/main > ${RESULT_DIR}/ubuntu/pool/Packages
gzip -9c ${RESULT_DIR}/ubuntu/pool/Packages > ${RESULT_DIR}/ubuntu/pool/Packages.gz
