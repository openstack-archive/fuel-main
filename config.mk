...
fuel,1,http://osci-obs.vm.mirantis.net:82/centos-fuel-$(PRODUCT_VERSION)-stable/centos
...
# USE_MIRROR=none mode is used only for building centos mirror, not for building ISO.
# That is why Ubuntu mirror variables are not defined here.
endif
