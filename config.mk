...
# MULTI_MIRROR_CENTOS:=repo1_name,repo1_uri,repo1_priority repo2_name,repo2_uri,repo2_priority

USE_MIRROR?=ext
ifeq ($(USE_MIRROR),ext)
MULTI_MIRROR_CENTOS?=\
ext,http://mirror.fuel-infra.org/fwm/$(PRODUCT_VERSION)/centos/os/$(CENTOS_ARCH),1
...
# We need this to fix community ISO building. Default sandbox mirror
# http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)/$(CENTOS_RELEASE)
# is unavailable from outside.
SANDBOX_MIRROR_CENTOS_UPSTREAM?=http://vault.centos.org/$(CENTOS_RELEASE)
endif
ifeq ($(USE_MIRROR),srt)
MULTI_MIRROR_CENTOS?=\
srt,http://osci-mirror-srt.srt.mirantis.net/fwm/$(PRODUCT_VERSION)/centos/os/$(CENTOS_ARCH),1
...
ifeq ($(USE_MIRROR),msk)
MULTI_MIRROR_CENTOS?=\
msk,http://osci-mirror-msk.msk.mirantis.net/fwm/$(PRODUCT_VERSION)/centos/os/$(CENTOS_ARCH),1
...
ifeq ($(USE_MIRROR),hrk)
MULTI_MIRROR_CENTOS?=\
kha,http://osci-mirror-kha.kha.mirantis.net/fwm/$(PRODUCT_VERSION)/centos/os/$(CENTOS_ARCH),1
...
ifeq ($(USE_MIRROR),usa)
MULTI_MIRROR_CENTOS?=\
usa,http://mirror.seed-us1.fuel-infra.org/fwm/$(PRODUCT_VERSION)/centos/os/$(CENTOS_ARCH),1
...
ifeq ($(USE_MIRROR),cz)
MULTI_MIRROR_CENTOS?=\
cz,http://mirror.seed-cz1.fuel-infra.org/fwm/$(PRODUCT_VERSION)/centos/os/$(CENTOS_ARCH),1
...
MULTI_MIRROR_CENTOS?=\
os,http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)/$(CENTOS_RELEASE)/os/$(CENTOS_ARCH),10 \
updates,http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)/$(CENTOS_RELEASE)/updates/$(CENTOS_ARCH),10 \
extras,http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)/$(CENTOS_RELEASE)/extras/$(CENTOS_ARCH),10 \
centosplus,http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)/$(CENTOS_RELEASE)/centosplus/$(CENTOS_ARCH),10 \
contrib,http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)/$(CENTOS_RELEASE)/contrib/$(CENTOS_ARCH),10 \
fuel,$(MIRROR_FUEL),1
...
# Each repo definition must be comma separated:
#  * triple: repo-name,repo-path,repo-priority
#       Example: EXTRA_RPM_REPOS="lolo,http://my.cool.repo/rpm,50 bar,ftp://repo.foo,10"
#         OR
#  * tuple:repo-name,repo-path.
#       Example: EXTRA_RPM_REPOS="lolo,http://my.cool.repo/rpm bar,ftp://repo.foo"
#    then the default priority will be set to 10
#
