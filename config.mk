...
MIRROR_UBUNTU?=http://osci-mirror-msk.msk.mirantis.net/pkgs/ubuntu-$(PRODUCT_VERSION)/
...
MIRROR_UBUNTU_SECURITY?=http://osci-mirror-msk.msk.mirantis.net/pkgs/ubuntu-security-$(PRODUCT_VERSION)/
