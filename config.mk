...
MIRROR_CENTOS?=http://mirror.fuel-infra.org/mos-repos/centos/mos$(PRODUCT_VERSION)-centos6-fuel/
MIRROR_CENTOS_KERNEL?=$(MIRROR_CENTOS)
SANDBOX_MIRROR_CENTOS_UPSTREAM?=http://mirror.fuel-infra.org/mos-repos/centos/mos$(PRODUCT_VERSION)-centos6-fuel/
