...
SANDBOX_MIRROR_CENTOS_UPSTREAM_BASEURL?=http://mirrors-local-msk.msk.mirantis.net/centos-$(PRODUCT_VERSION)
SANDBOX_MIRROR_CENTOS_UPSTREAM?=$(SANDBOX_MIRROR_CENTOS_UPSTREAM_BASEURL)/$(CENTOS_RELEASE)
SANDBOX_MIRROR_CENTOS_UPSTREAM_OS_BASEURL:=$(SANDBOX_MIRROR_CENTOS_UPSTREAM)/os/$(CENTOS_ARCH)/
SANDBOX_MIRROR_CENTOS_UPDATES_OS_BASEURL:=$(SANDBOX_MIRROR_CENTOS_UPSTREAM_BASEURL)/$(CENTOS_MAJOR)/updates/$(CENTOS_ARCH)/
