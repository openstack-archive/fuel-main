...
ifeq ($(USE_UPGRADE_PIP_ART_HTTP_LINK),)
	...
	$(BUILD_DIR)/upgrade/venv/bin/pip install -r $(BUILD_DIR)/repos/fuel-upgrade/fuel_upgrade/requirements.txt --download $(BUILD_DIR)/upgrade/deps --no-use-wheel
else
	...
	cd $(BUILD_DIR)/repos/fuel-upgrade/fuel_upgrade && $(BUILD_DIR)/upgrade/venv/bin/python setup.py sdist --dist-dir $(BUILD_DIR)/upgrade/deps
	$(ACTION.TOUCH)
