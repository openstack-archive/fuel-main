...
$(BUILD_DIR)/upgrade/venv.done:
	...
	sed 's/{{UPGRADERS}}/${UPGRADERS}/g' $(SOURCE_DIR)/upgrade/upgrade_template.sh > $(BUILD_DIR)/upgrade/venv/upgrade.sh
...
$(BUILD_DIR)/upgrade/common-part.done: \
	...
	tar rf $(BUILD_DIR)/upgrade/common-part.tar --mode=755 -C $(BUILD_DIR)/upgrade/venv upgrade.sh
	$(ACTION.TOUCH)
