...
$(BUILD_DIR)/upgrade/openstack-$1-part.tar:
	...
	tar xf $(OBJ_DIR)/$1/centos-repo.tar.gz -C $(BUILD_DIR)/upgrade/openstack-$1-part/upgrade/repos/$$(os_version_$1)/centos/x86_64
	mkdir -p $(BUILD_DIR)/upgrade/openstack-$1-part/upgrade/repos/$$(os_version_$1)/ubuntu/x86_64
	tar xf $(OBJ_DIR)/$1/ubuntu-repo.tar.gz -C $(BUILD_DIR)/upgrade/openstack-$1-part/upgrade/repos/$$(os_version_$1)/ubuntu/x86_64
