...
baseurl=http://mirror.fuel-infra.org/mos-repos/centos/mos${FUEL_RELEASE}-centos7-fuel/updates/x86_64/
gpgcheck=0
...
baseurl=http://mirror.fuel-infra.org/mos-repos/centos/mos${FUEL_RELEASE}-centos7-fuel/security/x86_64/
gpgcheck=0
skip_if_unavailable=1
EOF
