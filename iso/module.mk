...
version-yaml: $(ARTS_DIR)/$(VERSION_ART_NAME)

$(ARTS_DIR)/$(VERSION_ART_NAME): $(ISOROOT)/$(VERSION_ART_NAME)
	$(ACTION.COPY)

$(ISOROOT)/$(VERSION_ART_NAME): $(call depv,PRODUCT_VERSION)
$(ISOROOT)/$(VERSION_ART_NAME): $(call depv,FEATURE_GROUPS)
$(ISOROOT)/$(VERSION_ART_NAME): $(BUILD_DIR)/repos/repos.done
	echo "VERSION:" > $@
	echo "  feature_groups:" >> $@
