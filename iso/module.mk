...
$(ISO_PATH): $(BUILD_DIR)/iso/isoroot.done
	...
	# to root of it
	echo "  kernel /vmlinuz biosdevname=0 ks=cdrom:/dev/sr0:/ks.cfg ip=$(MASTER_IP) gw=$(MASTER_GW) dns1=$(MASTER_DNS) netmask=$(MASTER_NETMASK) hostname=fuel.domain.tld showmenu=yes" >> $(BUILD_DIR)/iso/isoroot-mkisofs/EFI/BOOT/BOOTX64.conf
