...
ifdef BUILD_NUMBER
$(BUILD_DIR)/iso/isoroot.done: $(ISOROOT)/build_number
$(ISOROOT)/build_number:
	echo "$(BUILD_NUMBER)" > $@
endif

ifdef BUILD_ID
$(BUILD_DIR)/iso/isoroot.done: $(ISOROOT)/build_id
$(ISOROOT)/build_id:
	echo "$(BUILD_ID)" > $@
endif
...
# remove this once jenkins-jobs is modified to stop copying this file
$(ISOROOT)/version.yaml: $(BUILD_DIR)/version.yaml
	$(ACTION.COPY)
