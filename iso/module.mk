...
$(ARTS_DIR)/mirror.yaml: $(MIRROR_YAML); $(ACTION.COPY)
...
$(BUILD_DIR)/mirror.done:
	@mkdir -p $(ISOROOT)
	packetary --threads-num 10 clone -t rpm -r $(MIRROR_YAML) -R $(SOURCE_DIR)/yaml/packages.yaml -d $(ISOROOT)
	$(ACTION.TOUCH)
