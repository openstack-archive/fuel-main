...
$(ISOROOT)/puppet-slave.tgz: \
		$(BUILD_DIR)/repos/fuel.done
		$(call find-files,$(BUILD_DIR)/repos/fuel/deployment/puppet)
	(cd $(BUILD_DIR)/repos/fuel/deployment/puppet && tar rf $(ISOROOT)/puppet-slave.tar ./*)
