...
$(ISO_PATH): $(BUILD_DIR)/iso/isoroot.done
	...
	mkdir -p $(BUILD_DIR)/iso/efi_image
	mount $(BUILD_DIR)/iso/isoroot-mkisofs/images/efiboot.img $(BUILD_DIR)/iso/efi_image
	...
	cp -f $(BUILD_DIR)/iso/isoroot-mkisofs/EFI/BOOT/BOOTX64.conf $(BUILD_DIR)/iso/efi_image/
	umount $(BUILD_DIR)/iso/efi_image
	rmdir $(BUILD_DIR)/iso/efi_image
