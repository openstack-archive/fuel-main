...
listing: $(BUILD_DIR)/iso/isoroot.done $(BUILD_DIR)/mirror.done
...
# IMAGES
#########
IMAGES_BASEURL ?= $(call $(notdir (RPM_REPOS_YAML))_0_uri)
...
$(ISOROOT)/ks.cfg: $(SOURCE_DIR)/iso/ks.template
	@mkdir -p $(@D)
	python $(SOURCE_DIR)/evaluator.py \
