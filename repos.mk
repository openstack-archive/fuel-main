...
$(BUILD_DIR)/repos/repos.done:
	...
	/bin/echo -n "  fuelmain_sha: \"`git rev-parse --verify HEAD`\"" >> $(BUILD_DIR)/repos/version.yaml
	$(ACTION.TOUCH)
...
$(BUILD_DIR)/repos/$1.done:
	...
	/bin/echo -n "  $1_sha: \"`cd $(BUILD_DIR)/repos/$1 && git rev-parse --verify HEAD`\"" >> $(BUILD_DIR)/repos/version.yaml
