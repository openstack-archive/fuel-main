...
class Settings(PageObject, SettingsFooter):
    ...
    def show_password(self):
        return self.parent.find_element_by_xpath('//div[input[@name="password"]]/span')
    ...
    @property
    def debug(self):
        return self.parent.find_element_by_xpath(self.XPATH_CHECKBOX.format('debug'))
    ...
    @property
    def assign_ip(self):
        return self.parent.find_element_by_xpath(self.XPATH_CHECKBOX.format('auto_assign_floating_ip'))
    ...
    def start_guests(self):
        return self.parent.find_element_by_xpath(self.XPATH_CHECKBOX.format('start_guests_on_host_boot'))
    ...
    def ceph_ephemeral(self):
        return self.parent.find_element_by_xpath(self.XPATH_CHECKBOX.format('ephemeral_ceph'))
