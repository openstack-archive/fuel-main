        ...
        while attempts < 3:
            try:
                if len(attributes) == 1:
                    ...
                    getattr(getattr(page_object, attributes[0])[attributes[2]], attributes[1]).click()
                elif len(attributes) == 4:
                    getattr(getattr(getattr(page_object, attributes[0])[attributes[3]],
        ...
        while attempts < 3:
            try:
                if len(attributes) == 1:
                    ...
                    getattr(getattr(page_object, attributes[0])[attributes[2]], attributes[1])
                elif len(attributes) == 4:
                    getattr(getattr(getattr(page_object, attributes[0])[attributes[3]],
