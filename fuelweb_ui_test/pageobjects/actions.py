...
class Actions(PageObject):
    ...
    def reset_popup(self):
        return self.parent.\
            find_element_by_xpath("//div[@class='modal-footer']/button[contains(@class,'reset-environment-btn')]")
    ...
    def stop_deploy(self):
        return self.parent.find_element_by_css_selector('button.stop-deployment-btn')

    @property
    def stop_deploy_popup(self):
        return self.parent.\
            find_element_by_xpath("//div[@class='modal-footer']/button[contains(@class,'stop-deployment-btn')]")
