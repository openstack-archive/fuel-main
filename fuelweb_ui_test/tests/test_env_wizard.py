...
class TestEnvWizard(BaseTestCase):
    ...
    """Test existing environment name
        ...
        Scenario:
            ...
            3. Enter 'test name'
            4. Click next button
            5. Verify that message 'Environment with name test name already exists' appears
    """
    ...
    """Test validation of empty RHEL form
        ...
        Scenario:
            ...
            3. Click next button
            4. Verify that 'Invalid username' and 'Invalid password' messages appear
    ...
    """Select environment network
        ...
        Scenario:
            1. Enter environment name
            2. Select Havana on Ubuntu in release list and click next three times
    ...
    """Select environment storage
        ...
        Scenario:
            1. Enter environment name
            2. Select Havana on Ubuntu in release list and click next four times
    ...
    """Cancel environment wizard
        ...
        Scenario:
            ...
            9. Click create environment again and check that all default values are selected
    """
...
class TestEnvWizardRedHat(BaseTestCase):
    ...
    """Download RHEL and RHOS by RHN satellite
        ...
        Scenario:
            ...
            2. Select RHOS in release list
            3. Select RHN option
            4. Enter Redhat username and password, satellite hostname and activation key
