...
class TestNodesAddPage(BaseTestCase):
    ...
    """Check selecting elements one by one
        ...
        Scenario:
            ...
            2. Verify that Select all checkbox for group is selected when all discovered nodes in group are selected
            3. Verify that Select all checkbox is selected when all nodes are selected
    """
...
class TestGroupBy(BaseTestCase):
    ...
    """Group nodes by role
        ...
        Scenario:
            ...
            2. Verify that there are 2 groups with correct number of nodes in each group
    """
    ...
    """Group nodes by hardware
        ...
        Scenario:
            ...
            2. Verify that there are 5 groups with correct number of nodes in each group
    """
    ...
    """Group nodes by role and hardware info
        ...
        Scenario:
            ...
            2. Verify that there are 6 groups with correct number of nodes in each group
    """
