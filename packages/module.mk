...
$(eval $(call prepare_file_source,fuel-target-centos-images$(IBP_CENTOS_RELEASE),fuel-target-centos-images$(IBP_CENTOS_RELEASE).tar,$(BUILD_DIR)/images/$(TARGET_CENTOS_IMG_ART_NAME),$(BUILD_DIR)/images/$(TARGET_CENTOS_IMG_ART_NAME)))
