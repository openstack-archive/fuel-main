ifeq ($(strip $(USE_MIRROR)),ext)
	MOCK_MIRROR?=$(MIRROR_CENTOS_OS_BASEURL)
    $(BUILD_DIR)/mock_mirror.done:
	  $(ACTION.TOUCH)
else
    $(BUILD_DIR)/mock_mirror.done:\
		$(BUILD_DIR)/mirror/build.done\
		$(ACTION.TOUCH)
	MOCK_MIRROR?=$(LOCAL_MIRROR_CENTOS_OS_BASEURL)
endif

include $(SOURCE_DIR)/packages/rpm/rpm_mock_config.mk

$(info: packages/rpm/module_mock.mk included)
...
$(BUILD_DIR)/packages/rpm/$1.done: $(BUILD_DIR)/mock_mirror.done
