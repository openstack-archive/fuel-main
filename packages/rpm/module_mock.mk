...
$(BUILD_DIR)/packages/rpm/mock-config.done: $(BUILD_DIR)/mirror/centos/repo.done
endif
...
# init chroot env
$(BUILD_DIR)/packages/rpm/mock-init.done: \
		$(BUILD_DIR)/packages/rpm/mock-config.done

	/usr/bin/mock --configdir=$(BUILD_DIR)/packages/rpm/mock \
	-r fuel-$(PRODUCT_VERSION)-$(CENTOS_ARCH) --init --cache-alterations --no-cleanup-after \
