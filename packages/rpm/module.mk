...
$(BUILD_DIR)/packages/rpm/buildd.tar.gz: MIRROR_TO_USE:=$(MIRROR_CENTOS_OS_BASEURL)
else
$(BUILD_DIR)/packages/rpm/buildd.tar.gz: MIRROR_TO_USE:=file://$(LOCAL_MIRROR_CENTOS_OS_BASEURL)
