...
# increment by 1 package release
...
$(BUILD_DIR)/packages/sources/$1/version:
	...
	bash -c "set -o pipefail && \
		yum -c $$(SANDBOX)/etc/yum.conf --installroot=$$(SANDBOX) info $1 | grep Release | tr -d ' ' | cut -d':' -f2 | xargs -I{} expr {} + 1 >> $$@"
endef
...
$(BUILD_DIR)/packages/rpm/fuel-docker-images.done: \
	...
	test -f $(BUILD_DIR)/packages/sources/fuel-docker-images/version && \
...
$(eval $(call inc_rpm_package_release,fuel-target-centos-images))
