...
$(BUILD_DIR)/packages/deb/$1-repocleanup.done: $(BUILD_DIR)/packages/source_$1.done
$(BUILD_DIR)/packages/deb/$1-repocleanup.done: $(BUILD_DIR)/mirror/ubuntu/reprepro.done
	cd $(LOCAL_MIRROR_UBUNTU) && perl $(SOURCE_DIR)/packages/deb/genpkgnames.pl $(BUILD_DIR)/repos/$1/debian/control | \
		xargs -I{} reprepro --confdir=$(LOCAL_MIRROR_UBUNTU)/conf remove $(PRODUCT_NAME)$(PRODUCT_VERSION) {}
	$$(ACTION.TOUCH)
endef
