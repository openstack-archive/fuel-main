...
xargs -n1 -I{} reprepro --distdir dists --confdir=$(REPREPRO_CONF_DIR) remove $(PRODUCT_NAME)$(PRODUCT_VERSION) {} $(NEWLINE)
$(SOURCE_DIR)/mirror/ubuntu/prepend_pool_path.sh dists/$(PRODUCT_NAME)$(PRODUCT_VERSION) dists/$(PRODUCT_NAME)$(PRODUCT_VERSION)/
endef
