...
$(BUILD_DIR)/packages/deb/$1.done: $(BUILD_DIR)/repos/repos.done
	...
	sudo chroot $$(SANDBOX_UBUNTU) /bin/sh -c "dpkg-checkbuilddeps /tmp/$1/debian/control 2>&1 | sed 's/^dpkg-checkbuilddeps: error: Unmet build dependencies://g' | sed 's/([^()]*)//g;s/|//g' | tee /tmp/$1.installdeps"
