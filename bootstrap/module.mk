...
KERNEL_FIRMWARE_PATTERN:=kernel-firmware*
...
$(BUILD_DIR)/bootstrap/prepare-initram-root.done: \
	...
	-sudo chroot $(INITRAMROOT) "rpm --dbpath /root/.rpmdb -qa >> /root/bootstrap_packages"

	# Some clean-up
	-sudo chroot $(INITRAMROOT) "rm -rf /root/.rpmdb"
