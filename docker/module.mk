...
$(BUILD_DIR)/docker/fuel-centos.done: \
	...
	sudo docker -D run --net=bridge -d -i -t --privileged -v $(LOCAL_MIRROR_CENTOS):/repo:ro -v $(BUILD_DIR)/docker/fuel-centos:/export fuel/fuel-centos-build | tee c.id && \
	sudo docker -D exec -i -t $(shell cat c.id) /usr/local/bin/start.sh 2>&1 && \
