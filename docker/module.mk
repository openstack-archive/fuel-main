...
$(BUILD_DIR)/docker/build.done: \
	...
	kill `cat /var/run/simple_http_daemon_$(RANDOM_PORT).pid`
...
$(BUILD_DIR)/docker/yum_http_repo.done: $(BUILD_DIR)/mirror/centos/build.done
	(cd $(LOCAL_MIRROR_CENTOS) && python $(SOURCE_DIR)/utils/simple_http_daemon.py $(RANDOM_PORT) /var/run/simple_http_daemon_$(RANDOM_PORT).pid)
	$(ACTION.TOUCH)
