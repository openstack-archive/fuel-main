...
$(BUILD_DIR)/docker/fuel-centos.done: \
	...
	container_id=$(sudo docker -D run --net=bridge --rm -a stdout -a stderr -i -t --privileged -v $(LOCAL_MIRROR_CENTOS):/repo:ro -v $(BUILD_DIR)/docker/fuel-centos:/export fuel/fuel-centos-build 2>&1) && \
	sudo docker -D exec -i -t ${container_id} /usr/local/bin/start.sh 2>&1 && \
