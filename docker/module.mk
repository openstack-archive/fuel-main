...
$(BUILD_DIR)/docker/fuel-centos.done: \
	...
	sudo docker -D run --net=bridge --rm -a stdout -a stderr -i -t --privileged -v /var/run/dbus:/var/run/dbus -v /run/systemd:/run/systemd -v $(LOCAL_MIRROR_CENTOS):/repo:ro -v $(BUILD_DIR)/docker/fuel-centos:/export fuel/fuel-centos-build 2>&1 && \
