...
$(BUILD_DIR)/docker/sources.done: \
	...
	cp -r $(SOURCE_DIR)/utils/extra_nets_from_cobbler.py $(BUILD_DIR)/docker/utils
	cp -r $(SOURCE_DIR)/utils/fuel-docker-images_post_upgrade.sh $(BUILD_DIR)/docker/utils
	$(ACTION.TOUCH)
