...
FUEL_DOCKER_FILE:=Dockerfile.vault
endif
...
$(BUILD_DIR)/docker/fuel-centos.done: \
	...
	sudo docker build -t fuel/fuel-centos-build -f $(BUILD_DIR)/docker/fuel-centos-build/$(FUEL_DOCKER_FILE) $(BUILD_DIR)/docker/fuel-centos-build
