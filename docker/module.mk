...
$(BUILD_DIR)/docker/fuel-centos.done: \
	...
	sudo docker -D run --net=bridge -d -i -t --privileged -v $(LOCAL_MIRROR_CENTOS):/repo:ro -v $(BUILD_DIR)/docker/fuel-centos:/export fuel/fuel-centos-build && \
	sudo docker -D exec -i -t $(shell sudo docker ps | awk '\$2 == "centos:centos7" {print \$1; exit}') /usr/local/bin/start.sh 2>&1 && \
