...
--cost=100
repo --name="Fuel CentOS" --baseurl=http://_REPOURL_:_REPOPORT_/os/x86_64
--cost 100
#repo --name="Updates"
--baseurl=http://mirror.centos.org/centos-6/6/updates/x86_64/ --cost=100
...
#repo --name="CentOSPlus"
--baseurl=http://mirror.centos.org/centos-6/6/centosplus/x86_64/ --cost=1000
