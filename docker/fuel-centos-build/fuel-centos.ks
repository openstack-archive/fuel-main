...
for service in dev-mqueue.mount dev-hugepages.mount \
    ...
    cryptsetup.target systemd-modules-load.service tuned.service \
    crond.service sysstat.service \
    systemd-sysctl.service microcode.service \
    systemd-binfmt.service systemd-reboot.service \
    NetworkManager-dispatcher.service irqbalance.service crond.service; do
