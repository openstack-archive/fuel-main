...
ln -snf /dev/null /etc/systemd/system/firewalld.service
# Mask autitd.service
ln -snf /dev/null /etc/systemd/system/autitd.service
# Mask systemd-remount-fs.service
ln -snf /dev/null /etc/systemd/system/systemd-remount-fs.service
