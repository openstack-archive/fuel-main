...
# packages
SANDBOX_PACKAGES="bash git python-setuptools python-pbr ruby rpm-build sudo shadow-utils tar yum yum-utils"

# centos mirror
MIRROR=${CENTOS_MIRROR:-http://mirror.fuel-infra.org/mos-repos/centos/mos${PRODUCT_VERSION}-centos6-fuel/os/x86_64/}
