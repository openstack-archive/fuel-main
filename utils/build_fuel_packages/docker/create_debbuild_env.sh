...
UBUNTU_MIRROR_SUFFIX=${UBUNTU_MIRROR_SUFFIX:-/pkgs/ubuntu}
...
#MOS mirrors
deb ${MIRROR}${MIRROR_UBUNTU_ROOT} ${PRODUCT_NAME}${PRODUCT_VERSION} main restricted
deb ${MIRROR}${MIRROR_UBUNTU_ROOT} ${PRODUCT_NAME}${PRODUCT_VERSION}-security main restricted
deb ${MIRROR}${MIRROR_UBUNTU_ROOT} ${PRODUCT_NAME}${PRODUCT_VERSION}-proposed main restricted
deb ${MIRROR}${MIRROR_UBUNTU_ROOT} ${PRODUCT_NAME}${PRODUCT_VERSION}-updates main restricted
deb ${MIRROR}${MIRROR_UBUNTU_ROOT} ${PRODUCT_NAME}${PRODUCT_VERSION}-holdback main restricted
